...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoicmFpem8iLCJhIjoiY2twdGFrcDR4MGhtMDJ2bm8wYnk2M252byJ9.xsbO-rDTmytwiQ7oVGiXng";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/raizo/ckptc130829zs18ntfjf2dorg",
    scrollZoom: false //   center: [78.9629, 20.5937],
    //   zoom: 4,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the map bound to include current lpcation
...
var stripe = Stripe("pk_test_51J2xdVSD2N7voyjiPC6uLUrMxxINQBSZoCUy2m4An8mf7sjQFOvFTHjMTxEOSqkSoHfxyXOry95kDLtTFonMEucq00lM89ftho");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // ii) Create checkout form + process
...
if (userDataForm) userDataForm.addEventListener("submit", function (e) {
  ...
  console.log(form);
  (0, _update.updateData)(form, "data");
});
